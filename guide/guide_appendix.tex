...
\begin{longtable}{llp{0.7\textwidth}}
  ...
  \midrule
  10 Mar 2018 & 6.0 & After a \Command{make new} the \File{mythesis} directory should now be standalone.
    This make it easier to use Git etc.
    Bibliography files now go in \File{bib} subdirectory.
...
\item Add drawing of Feynman graphs with \Package{axodraw} and/or
  \Package{jaxodraw}.
\item Add drawing of Feynman graphs with \Package{PyFeyn}.
...
If you have a glossary and want it to compile it using \Command{latexmk}
