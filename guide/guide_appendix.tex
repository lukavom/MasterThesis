...
\noindent
In this section I use to document briefly the major changes to this guide.
...
\setmathfont{texgyretermes-regular.otf}
\setmathfont[version=bold]{texgyretermes-regular.otf}
\end{tcblisting}
\noindent in \File{ubonn-thesis.sty}.
