...
\begin{longtable}{llp{0.7\textwidth}}
  ...
  \midrule
  16 June 2020 & 7.0 & Remove support and documentation for \TeXLive versions older than 2011.
    Thesis skeleton and guide can also be compiled using Lua\LaTeX and Xe\LaTeX.
...
If you want to use Lua\LaTeX\ you also have to install \texttt{texlive-luatex}
and if you want to use Xe\LaTeX\ you have to install \texttt{texlive-xetex}.
You may also have to install \texttt{texlive-xetex} even if you only plan to use Xe\LaTeX.
...
If your version of \TeXLive is older than 2016, you should set
\Macro{texlive} accordingly.
...
This tweak does not work with Xe\LaTeX{} and Lua\LaTeX,
