...
\begin{longtable}{llp{0.7\textwidth}}
  ...
  30 Jun 2016 & 5.1 & Add \Package{hepnicenames} and \Package{heppennames} packages.
    ...
    Move back to american and british as languages rather than USenglish and UKenglish,
    as \Package{csquotes} gives warnings when using USenglish as a foreign language.\\
...
selected. If your version of \TeXLive is older than 2013, you should set
