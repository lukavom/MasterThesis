...
generate them? 
For the past few years I have used a Python package \Package{PyFeyn} (\url{https://pyfeyn.hepforge.org})
...
\Package{TikZ-Feynman} requires you to use Lua\LaTeX,
so I will only give examples for \Package{TikZ-FeynHand} here.
...
with a Feynman graph size of about \SI[parse-numbers=false]{2 by 2}{\cm^{2}}
...
It is also debatable whether \Package{feymp} or \Package{\TikZ} is better.
...
In the TikZ-FeynHand graph, I use lots of colours to illustrate how they work.
