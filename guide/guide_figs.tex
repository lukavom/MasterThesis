...
of the \Env{fmffile} environment. While Metapost works will with
\TeXLive 2011, I did not get it to work properly with \TeXLive 2009
for unknown reasons.
...
\begin{figure}[htbp]
  ...
  \subfloat[\TikZ][\TikZ]{\label{fig:feyn:tikz}
    \ifthenelse {\texlive = 2009} {%
      Error messages appear when trying to compile the guide with
      \Package{tikz} and \TeXLive 2009, so the figure cannot be included.
    }{%
