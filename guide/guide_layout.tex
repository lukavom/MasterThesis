...
I have tried to compile the guide using Xe\LaTeX\index{XeLaTeX} Lua\LaTeX\index{LuaLaTeX}.
After a few tweaks it mostly works.
However, Xe\LaTeX\ has problems with Greek letters in section titles.
Lua\LaTeX\ seems to have problems with some tables, as well as listings.
You can use the command \Command{make guidexe} to try to compile using Xe\LaTeX.
You can use the command \Command{make guidelua} to try to compile using Xe\LaTeX.
...
I need to tweak settings more before the options can be considered anything other than experikmental!
