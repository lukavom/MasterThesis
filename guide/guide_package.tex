...
The thesis skeleton uses the \Package{background} for this.
It is only available as of \TeXLive 2011.
If you have an older version of \TeXLive you can use \Package{draftwatermark} instead.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lp{0.8\textwidth}}
    ...
    \Package{draftwatermark} & Another package that allows you to add DRAFT to each page.\\
