...
The \Package{cleveref} package appears to be a great package for specifying references to
...
\Macro{missingfigure\{text\}} to indicate figures that you still want to include.
