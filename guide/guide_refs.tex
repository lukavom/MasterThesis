...
setting for \TeXLive 2011 and earler), then you have to encode your \texttt{.bib}
...
cited. \Option{biber} seems to work well with \TeXLive 2012 and later; it is
...
2011 or earler, and therefore the \texttt{bibtex8} backend, the
