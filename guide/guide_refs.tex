...
% This is only be available in recent releases (\(\geq 2011\)) of \TeXLive. 
...
Use the option \Option{astrobib} to format the bibliography in the style usually used in astrophysics theses.
