...
make thesis
\end{verbatim}
If your version of \TeXLive is lower than 2011, use the command \enquote{\texttt{make thesis09}}
or \enquote{\texttt{make thesis BIBTEX='bibtex8 -H'}}.
...
by giving a command like \enquote{\texttt{make new TEXLIVE=2009}}.
...
If you want to compile the guide with \TeXLive older than 2009,
you probably have to switch from \Package{biblatex} to traditional \BibTeX.
