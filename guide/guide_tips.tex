...
\begin{xtabular}{llp{11.0cm}}
  ...
  eVkern & Apply a kern of -0.1em to \si{\eV} in order to move \enquote{e} and \enquote{V} closer together.\\
...
\item Use \Macro{enquote} from the \PackageG{csquotes} package to
  ...
  (and dialect\footnote{%
    ...
    uses \foreignquote{american}{American quoted text}. In this guide
    (and in \texttt{ubonn-thesis.sty})
    \foreignquote{american}{American (US) quotes} are used even if you
