...
%------------------------------------------------------------------------------
% Use biblatex alphabetic style without sorting and block
...
\ifthenelse {\texlive = 2009} {%
  ...
  style=alphabetic,block=ragged,firstinits=true]{biblatex}
}{%
...
\ifthenelse {\texlive = 2009} {%
  ...
  \bibliography{./guide/guide_refs.bib,%
    ./refs/standard_refs-bibtex.bib,%
    ./refs/example_refs-latin1.bib,%
    ./guide/refs/zeus_2009.bib,%
    ./guide/refs/zeus_2010.bib}
}{%
  % Adjustments to output are in this style file:
  \usepackage{./biblatex/biblatex-num-v2011}
  \addbibresource{./guide/guide_refs.bib}
...
\newcommand{\thesisabstract}{%
  \begin{otherlanguage}{UKenglish}
    ...
    Department of Physics and Astronomy of the University of Bonn. It
    contains examples and recommendations on what packages to use and
    how to use them. Variants of the file also provides title pages
    for PhD, Diplom, Master and Bachelor theses. It makes no attempt
    to be an introduction to \LaTeX. Indeed some basic \LaTeX{}
    knowledge is assumed. It is very much geared to (particle) physics
    theses, but may be useful for others.
  \end{otherlanguage}
}

%------------------------------------------------------------------------------
% \includeonly can be used to select which chapters you want to process
% A simple \include command just inserts a \clearpage before and after the fi% Note that \includeonly can be quite picky! Do not forget to put a
% comma after the filename, otherwise it will simply be ignored!
% \includeonly{%
%   guide/guide_acknowledge1,
%   guide/guide_intro,
%   guide/guide_tips,
%   guide/guide_submit,
%   guide/guide_package,
...
%   guide/guide_refs,
%   guide/guide_layout,
%   guide/guide_appendix,
%   guide/guide_acknowledge2
% }
...
%------------------------------------------------------------------------------
\include{guide/guide_acknowledge1}
...
%------------------------------------------------------------------------------
\include{guide/guide_intro}

\include{guide/guide_tips}

\include{guide/guide_submit}

\include{guide/guide_package}

\include{guide/guide_figs}

\include{guide/guide_tables}

\include{guide/guide_refs}

\include{guide/guide_layout}
...
%   \bibliography{./refs/standard_refs-bibtex,./refs/example_refs-latin1,%
...
%------------------------------------------------------------------------------
% Acknowledgements
\include{guide/guide_acknowledge2}
